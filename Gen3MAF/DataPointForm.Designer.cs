namespace Gen3MAF
{
    partial class DataPointForm
    {
        ...
        {
            Frequency_label = new Label();
            LeftFrequncy_label = new Label();
            RightFrequency_label = new Label();
            Airflow_label = new Label();
            LeftAirflow_label = new Label();
            RightAirflow_label = new Label();
            AirflowAdjustment_label = new Label();
            RightAirflowAdjustment_label = new Label();
            LeftAirflowAdjustment_label = new Label();
            AdjustedAirflow_label = new Label();
            AdjustedAirflowLeft_label = new Label();
            AdjustedAirflowRight_label = new Label();
            OK_button = new Button();
            SlopeLeft_label = new Label();
            SlopeRight_label = new Label();
            LeftBucket_label = new Label();
            CenterBucket_label = new Label();
            RightBucket_label = new Label();
            IntermediateAdjustedAirflow_label = new Label();
            ...
            // Frequency_label
            // 
            Frequency_label.AutoSize = true;
            Frequency_label.Location = new Point(218, 9);
            Frequency_label.Name = "Frequency_label";
            Frequency_label.Size = new Size(49, 20);
            Frequency_label.TabIndex = 0;
            Frequency_label.Text = "12000";
            // 
            // LeftFrequncy_label
            // 
            ...
            RightFrequency_label.Text = "12063";
            // 
            // Airflow_label
            // 
            ...
            Airflow_label.Text = "1000";
            Airflow_label.Click += Airflow_label_Click;
            // 
            // LeftAirflow_label
            // 
            ...
            AirflowAdjustment_label.Text = "0.0";
            // 
            ...
            RightAirflowAdjustment_label.Text = "1.0";
            // 
            ...
            LeftAirflowAdjustment_label.Text = "-1.0";
            // 
            ...
            AdjustedAirflow_label.Text = "999";
            // 
            ...
            AdjustedAirflowLeft_label.Text = "890";
            // 
            ...
            AdjustedAirflowRight_label.Text = "1100";
            // 
            // OK_button
            // 
            ...
            IntermediateAdjustedAirflow_label.Text = "990";
            // 
            // LeftBucketEnd_label
            // 
            ...
            Controls.Add(IntermediateAdjustedAirflow_label);
            Controls.Add(RightBucket_label);
            Controls.Add(CenterBucket_label);
            Controls.Add(LeftBucket_label);
            Controls.Add(SlopeRight_label);
            Controls.Add(SlopeLeft_label);
            Controls.Add(OK_button);
            Controls.Add(AdjustedAirflowRight_label);
            Controls.Add(AdjustedAirflowLeft_label);
            Controls.Add(AdjustedAirflow_label);
            Controls.Add(LeftAirflowAdjustment_label);
            Controls.Add(RightAirflowAdjustment_label);
            Controls.Add(AirflowAdjustment_label);
            Controls.Add(RightAirflow_label);
            Controls.Add(LeftAirflow_label);
            Controls.Add(Airflow_label);
            Controls.Add(RightFrequency_label);
            Controls.Add(LeftFrequncy_label);
            Controls.Add(Frequency_label);
            Name = "DataPointForm";
            Text = "DataPointForm";
            Load += DataPointForm_Load;
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private Label Frequency_label;
        private Label LeftFrequncy_label;
        private Label RightFrequency_label;
        private Label Airflow_label;
        private Label LeftAirflow_label;
        private Label RightAirflow_label;
        private Label AirflowAdjustment_label;
        private Label RightAirflowAdjustment_label;
        private Label LeftAirflowAdjustment_label;
        private Label AdjustedAirflow_label;
        private Label AdjustedAirflowLeft_label;
        private Label AdjustedAirflowRight_label;
        private Button OK_button;
        private Label SlopeLeft_label;
        private Label SlopeRight_label;
        private Label LeftBucket_label;
        private Label CenterBucket_label;
        private Label RightBucket_label;
        private Label IntermediateAdjustedAirflow_label;
